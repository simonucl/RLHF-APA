...
class AccelerateRLTrainer(BaseRLTrainer):
    ...
    def __init__(self, config, **kwargs):  # noqa: C901
        ...
        # self.model.base_model = self.model.base_model.to(device)
        # self.model.v_net = self.model.v_net.to(device)
        # self.model.v_head = self.model.v_head.to(device)
...
@register_trainer
class AccelerateRLTrainerNoV(BaseRLTrainer):
    """
    RL model trainer with an `accelerate` based backend
    """
